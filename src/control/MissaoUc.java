...
public class MissaoUc {
    ...
    public String coletarCoroa(String resposta) {
        ...
        if (tentativa.equalsIgnoreCase("A") && opcoes.size() > 0)
            tentativa = opcoes.get(0);
        else if (tentativa.equalsIgnoreCase("B") && opcoes.size() > 1)
            tentativa = opcoes.get(1);
        else if (tentativa.equalsIgnoreCase("C") && opcoes.size() > 2)
            tentativa = opcoes.get(2);
